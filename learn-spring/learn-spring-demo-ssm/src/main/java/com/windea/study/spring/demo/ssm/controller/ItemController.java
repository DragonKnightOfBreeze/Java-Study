package com.windea.study.spring.demo.ssm.controller;

import com.windea.study.spring.demo.ssm.domain.Item;
import com.windea.study.spring.demo.ssm.domain.ItemQueryVo;
import com.windea.study.spring.demo.ssm.service.IItemService;
...
public class ItemController {
	...
	@Autowired
	public ItemController(IItemService service) {this.service = service;}
