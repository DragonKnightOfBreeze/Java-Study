...
<form action="${URL }" method="post" name="pageListForm">
  <table>
    <tr>
      <td colspan="7">
        ...
        <input type="button" value="下一页"
               onclick="changePage(${p.currentPage+1})" ${p.currentPage>=p.pageTotal?"disabled":""} />
        <input type="button" value="尾页"
               onclick="changePage(${p.pageTotal})" ${p.currentPage==p.pageTotal?"disabled":""}/>
