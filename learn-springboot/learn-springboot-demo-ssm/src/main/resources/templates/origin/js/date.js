...
if(typeof (jsIEFirefoxCalendar) != 'number') {
  ...
  var crossobj, cnsJsIeFirefoxCalendarCrossMonthObj, crossYearObj, monthSelected, yearSelected, dateSelected,
    omonthSelected, oyearSelected, odateSelected, monthConstructed, yearConstructed, intervalID1, intervalID2,
    timeoutID1, timeoutID2, ctlToPlaceValue, ctlNow, dateFormat, nStartingYear, nStartingMonth;
  ...
  var imgsrc = ["drop1.gif", "drop2.gif", "left1.gif", "left2.gif", "right1.gif", "right2.gif"];
  ...
  */
  ...
  function cnsJsIeFirefoxCalendarInit() {
    ...
    if(!ns4) {
      ...
      var sHTML1 = "<span  id='spanLeft' style='border-style:solid;border-width:1px;border-color:#3366FF;cursor:pointer'     onclick='decMonth()' onmousedown='clearTimeout(timeoutID1);timeoutID1=setTimeout(\"StartDecMonth()\",500)' onmouseup='clearTimeout(timeoutID1);clearInterval(intervalID1)'  title='上一月' >&nbsp;&laquo;&nbsp;</span>&nbsp;";
